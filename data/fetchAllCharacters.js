...
async function getAllMarvelCharacters() {
  ...
  fs.writeFileSync('marvel_character_ids.json', JSON.stringify(characterIds, null, 2));

  console.log(`File 'marvel_character_ids.json' creato con successo. Totale ID: ${characterIds.length}`);
}
